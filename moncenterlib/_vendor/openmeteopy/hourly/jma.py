from moncenterlib._vendor.openmeteopy.hourly.meteo_france import HourlyMeteoFrance
from moncenterlib._vendor.openmeteopy.exceptions import MethodnotAllowed
